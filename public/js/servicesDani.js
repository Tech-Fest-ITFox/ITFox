angular.module('ServicesDani', [])
    .factory('MainD', ['$http', '$localStorage', '$sessionStorage',
        function ($http, $localStorage, $sessionStorage) {
            ...
            function getUserFromToken() {
                var token = $sessionStorage.foxToken;
                var user = {};
            ...
            return {
                register: function (data, success, error) {
                    $http.post(baseUrl + '/api/register', data).success(success).error(error)
                },
                ...
                logout: function (success) {
                    changeUser({});
                    delete $sessionStorage.foxToken;
                    $sessionStorage.$save();
                    success();
                },
